 ...
 * Each cell: 1 leading space + 9-char key field + 15-char desc field = 25
 * chars. Row:  │<cell25>│<cell25>│<cell25>│  = 4 + 75 = 79 chars. Sep:
 * ├<25─>┼<25─>┼<25─>┤          = 79 chars.
 *
...
const char *kg_help_lines[]
	...
	"──────────────────────────────────────────────────────────────┐",
	      ...
	      "├─────────────────────────┼─────────────────────────┼───────────"
	      "──────────────┤",
	      "│ C-f/C-b  fwd/back char  │ BS       del back       │ C-x C-s  "
	      "save           │",
	      "│ C-n/C-p  down/up line   │ C-d/DEL  del fwd        │ C-x s    "
	      "save all       │",
	      "│ C-a/C-e  bol/eol        │ C-k      kill line      │ C-x C-f  "
	      "open file      │",
	      "│ C-v/M-v  page dn/up     │ C-_      undo           │ C-x C-r  "
	      "open r/o       │",
	      "│ M-f/M-b  word fwd/bk    │ C-o      open line      │ C-x C-w  "
	      "write file     │",
	      ...
	      "├─────────────────────────┼─────────────────────────┼───────────"
	      "──────────────┤",
	      "│ C-SPC      set mark     │ C-x SPC  rect mark mode │ C-x 2/3  "
	      "split h / v    │",
	      "│ C-x C-x    exch mark    │ C-x r k  kill rect      │ C-x o    "
	      "other window   │",
	      "│ S-arrow    extend       │ C-x r y  yank rect      │ C-x 0/1  "
	      "del wnd/others │",
	      "│ C-w/S-Del  cut          │ C-x r d  delete rect    │ C-s/C-r  "
	      "search fwd/bk  │",
	      "│ M-w/C-Ins  copy         │ C-x r c  clear rect     │ M-%      "
	      "query replace  │",
	      "│ C-y/S-Ins  paste        │ C-x r t  string rect    │ M-C-s/r  "
	      "regexp search  │",
