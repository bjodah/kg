...
**Cell allocation.**  (1) Pairs, everywhere, by a wide margin.  (2) Boxed
integers -- second in every workload that allocates any, and ~50% of the
arithmetic loop.  (3) String cells, at seven payload bytes each: a bare
