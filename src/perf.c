...
const char *const kg_perf_counter_name[KG_PERF_COUNTER_COUNT] = {
	...
	[KG_PERF_LISP_PAYLOAD_CAPACITY] = "lisp_payload_capacity",
	[KG_PERF_LISP_PAYLOAD_LIVE] = "lisp_payload_live",
	[KG_PERF_LISP_PAYLOAD_PEAK] = "lisp_payload_peak",
	[KG_PERF_LISP_PAYLOAD_COMPACTIONS] = "lisp_payload_compactions",
	[KG_PERF_LISP_PAYLOAD_FAILURES] = "lisp_payload_failures",
	...
	[KG_PERF_LSP_LINES_READ] = "lsp_lines_read",
	[KG_PERF_IDLE_WAIT] = "idle_wait",
	[KG_PERF_IDLE_TICK] = "idle_tick",
	[KG_PERF_IDLE_FD_WAKE] = "idle_fd_wake",
};
