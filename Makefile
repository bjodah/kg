...
# path picker's literal-accept answers; 4280 -> 4223 -> 4221 -> 4217 as
# the follow-up program's slices funded themselves and banked what was
# left.)
SCC_COMPLEXITY_MAX ?= 4217
