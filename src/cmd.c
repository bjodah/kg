...
static const struct named_cmd cmdtable[] = {
	...
	{ "isearch-backward", cmd_isearch_backward, READS_TERM | KEEPS_GOAL,
	    "Incremental search backward" },
	{ "isearch-backward-regexp", cmd_isearch_backward_regexp,
	    READS_TERM | KEEPS_GOAL, "Incremental regexp search backward" },
	{ "isearch-forward", cmd_isearch_forward, READS_TERM | KEEPS_GOAL,
	    "Incremental search forward" },
	{ "isearch-forward-regexp", cmd_isearch_forward_regexp,
	    READS_TERM | KEEPS_GOAL, "Incremental regexp search forward" },
