...
static const struct binding global_bindings[] = {
	...
	{ CTRL_L, "C-l", "key_recenter", "recenter-top-bottom", 0, K_CMD,
	    L_GLOBAL, RO_FREE, 0, "recenter-cycle-centre-top-bottom",
	...
	{ ALT_E, "M-e", "editor_move_sentence_forward", "forward-sentence", 0,
	    K_CMD, L_GLOBAL, RO_FREE, 0, NULL, NULL },
	{ ALT_R, "M-r", "editor_move_to_window_line",
	    "move-to-window-line-top-bottom", 0, K_CMD, L_GLOBAL, RO_FREE, 0,
